    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solution', models.CharField(choices=[('accept', 'принят'), ('cancel', 'отменен'), ('wait', 'ожидание')], default='wait', help_text='Принятое решение библиотекарем', verbose_name='решение')),
